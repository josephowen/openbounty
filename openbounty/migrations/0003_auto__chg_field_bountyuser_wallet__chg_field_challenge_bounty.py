...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BountyUser.wallet'
        db.alter_column(u'openbounty_bountyuser', 'wallet', self.gf('django.db.models.fields.DecimalField')(max_digits=500, decimal_places=2))

        # Changing field 'Challenge.bounty'
        db.alter_column(u'openbounty_challenge', 'bounty', self.gf('django.db.models.fields.DecimalField')(max_digits=500, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'BountyUser.wallet'
        db.alter_column(u'openbounty_bountyuser', 'wallet', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Challenge.bounty'
        db.alter_column(u'openbounty_challenge', 'bounty', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        u'openbounty.bountyuser': {
            ...
            'wallet': ('django.db.models.fields.DecimalField', [], {'max_digits': '500', 'decimal_places': '2'})
        },
