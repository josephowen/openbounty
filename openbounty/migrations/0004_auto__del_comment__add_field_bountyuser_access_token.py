...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BountyUser.access_token'
        db.add_column(u'openbounty_bountyuser', 'access_token',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BountyUser.access_token'
        db.delete_column(u'openbounty_bountyuser', 'access_token')
