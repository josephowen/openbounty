...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BountyUser.venmo'
        db.add_column(u'openbounty_bountyuser', 'venmo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=12, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BountyUser.venmo'
        db.delete_column(u'openbounty_bountyuser', 'venmo')
    ...
    models = {
        ...
        u'openbounty.bountyuser': {
            ...
            'venmo': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '12', 'blank': 'True'}),
