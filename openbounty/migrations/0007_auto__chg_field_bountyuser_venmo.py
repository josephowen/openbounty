...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BountyUser.venmo'
        db.alter_column(u'openbounty_bountyuser', 'venmo', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'BountyUser.venmo'
        db.alter_column(u'openbounty_bountyuser', 'venmo', self.gf('django.db.models.fields.CharField')(max_length=12))
