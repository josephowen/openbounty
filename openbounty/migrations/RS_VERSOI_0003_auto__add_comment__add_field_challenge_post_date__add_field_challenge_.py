...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Challenge.post_date'
        db.add_column(u'openbounty_challenge', 'post_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Challenge.fulfilled'
        db.add_column(u'openbounty_challenge', 'fulfilled',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Challenge.post_date'
        db.delete_column(u'openbounty_challenge', 'post_date')

        # Deleting field 'Challenge.fulfilled'
        db.delete_column(u'openbounty_challenge', 'fulfilled')
